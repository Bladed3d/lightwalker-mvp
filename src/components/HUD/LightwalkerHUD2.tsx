      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col items-center justify-center bg-gray-900/50 rounded-lg border border-cyan-800/30 p-6">
            ...
            <p className="mt-6 text-cyan-400 font-medium text-lg">
              {isLightwalkerSpeaking ? 'Speaking...' : 'Active'}
            </p>
            <p className="text-cyan-600">Currently: Morning Routine</p>
            
            {/* Simple stats below */}
            <div className="mt-8 flex gap-8">
              <div className="text-center">
                <p className="text-3xl font-bold text-cyan-300">78%</p>
                <p className="text-cyan-600 text-sm">Sync Level</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-cyan-300">14</p>
                <p className="text-cyan-600 text-sm">Day Streak 🔥</p>
              </div>
            </div>
          </div>
        </div>
