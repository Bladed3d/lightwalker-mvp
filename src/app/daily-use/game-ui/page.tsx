...
export default function DailyUseGameUI() {
  // Data hooks
  const {
    schedule,
    lightwalkerState,
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Loading Game Interface...</h2>
          <p className="text-slate-300">Preparing your daily adventures</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 text-white">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Live Your Best Self</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="grid grid-cols-12 gap-6 min-h-[calc(100vh-8rem)]">
          ...
          {/* Section 1: Timeline - Top Span */}
          <div className="col-span-12 bg-slate-800/30 rounded-lg p-4 border border-slate-700">
            ...
            <div className="flex space-x-4 overflow-x-auto pb-2">
              {schedule.activities.slice(0, 8).map((activity, index) => (
                <div
                  key={activity.id}
                ...
                >
                  <div className="text-sm font-medium">{activity.scheduledTime}</div>
                  <div className="text-xs mt-1">{activity.title}</div>
            ...
            <div className="bg-slate-800/30 rounded-lg p-4 border border-slate-700">
              ...
              <div className="bg-slate-700 rounded-lg p-3 mb-3">
                <div className="text-sm text-cyan-100">
                  {currentActivity ? 
                    `I'm focusing on ${currentActivity.title} right now. How's your progress?` :
                    `Ready to start your day? What would you like to work on first?`
                  }
                </div>
