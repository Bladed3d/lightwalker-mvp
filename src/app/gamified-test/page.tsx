...
export default function GamifiedTestPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto p-8">
          ...
          <button 
            ...
            className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-bold rounded-lg hover:shadow-lg transition-all duration-300"
          >
  ...
  return (
    <div>
      <GamifiedDiscoveryDashboard onLightwalkerCreated={handleLightwalkerCreated} />
    </div>
  )
}